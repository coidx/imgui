...
bool ImGui_ImplAllegro5_ProcessEvent(ALLEGRO_EVENT* ev)
{
    ...
    case ALLEGRO_EVENT_KEY_UP:
        if (ev->keyboard.display == bd->Display)
        {
            ...
            io_event.Key = ImGui_ImplAllegro5_KeyCodeToImGuiKey(ev->keyboard.keycode);
            io_event.Down = (ev->type == ALLEGRO_EVENT_KEY_DOWN);
            io_event.NativeKeycode = ev->keyboard.keycode;
